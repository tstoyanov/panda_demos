...
#include <rl_task_plugins/tdyn_random.h>
...
namespace hiqp
{
  namespace tasks
  {
    ...
    int TDynRandom::update(const RobotStatePtr robot_state, 
      ...
      random_e_.resize(def->getTaskValue().size());
      double sample = 0;
      ...
      e_ddot_star_ = random_e_;
      //TODO: TSV: this is a hardcoded geometric primitive
      //TODO: What is the point of this code? error is already set above
#if 0
