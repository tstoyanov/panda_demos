...
for values in trajectories["fk_eef_trajectory"]:
    fk_eef_pose["x"].append(values["x"])
    fk_eef_pose["y"].append(values["y"])
    fk_eef_pose["z"].append(values["z"])
# =============================================================================
# feedback processing
...
ax.scatter3D(eef_pose["x"], eef_pose["y"], eef_pose["z"], c=eef_pose["z"], cmap='Greens', label="eef_trajectory");

# fig = plt.figure("fk_eef_trajectory")
# ax = fig.add_subplot(111, projection='3d')
ax.scatter3D(fk_eef_pose["x"], fk_eef_pose["y"], fk_eef_pose["z"], c=fk_eef_pose["z"], marker='^', cmap='Reds', label="fk_eef_trajectory");
plt.legend()
