  ...
  for u_step in 10 20; do
    for noise in 0.4 0.6 0.8; do
      for runid in 0 1 2 3 4; do
        /home/quantao/anaconda3/envs/py37/bin/python main.py --env PandaEnv --seed ${seed} --num_episodes 100 --run_id ${runid} --noise_scale ${noise} --logdir \
/home/quantao/naf_logs/action_project/ --updates_per_step ${u_step} --exploration_end 90 --project_actions=True
